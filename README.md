...
Note: this command must be run in the root of the repository.

## Demo Applications

### Revolut Pay Lite SDK Demo
...
<b>Integration guide:</b> [here](https://github.com/revolut-mobile/revolut-payments-react-native/blob/master/packages/revolut-merchant-card-form-demo/README.md)
...
<b>Integration guide:</b> [here](https://github.com/revolut-mobile/revolut-payments-react-native/blob/master/packages/revolut-pay-lite-demo/README.md)
