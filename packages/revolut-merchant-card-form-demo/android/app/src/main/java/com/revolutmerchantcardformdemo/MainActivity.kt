package com.revolutmerchantcardformdemo
...
class MainActivity : ReactActivity(), CardPaymentLauncherHolder {
     ...
     */
    override fun getMainComponentName(): String = "RevolutMerchantCardFormDemo"
    ...
    /**
     * Should be defined unconditionally for future Revolut card payments
     */
